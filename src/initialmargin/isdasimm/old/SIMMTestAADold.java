...
import initialmargin.isdasimm.old.SIMMAADold.CurrencyVolatility;
import initialmargin.isdasimm.old.SIMMAADold.WeightToLiborAdjustmentMethod;
...
public class SIMMTestAADold {
	...
	public static void main(String[] args) throws SolverException, CloneNotSupportedException, CalculationException {
        ...
        // SIMM
		SIMMAADold SIMM_StochasticWeightAdj = new SIMMAADold(model, products, CurrencyVolatility.RegularCurrency, WeightToLiborAdjustmentMethod.Stochastic, true /*MulticurveFlag*/);
		SIMMAADold SIMM_ConstantWeightAdj   = new SIMMAADold(model, products, CurrencyVolatility.RegularCurrency, WeightToLiborAdjustmentMethod.Constant, true /*MulticurveFlag*/);
		
		SIMMAADold SIMM_StochasticWeightAdjSteep = new SIMMAADold(model2, products, CurrencyVolatility.RegularCurrency, WeightToLiborAdjustmentMethod.Stochastic, true /*MulticurveFlag*/);
		SIMMAADold SIMM_ConstantWeightAdjSteep   = new SIMMAADold(model2, products, CurrencyVolatility.RegularCurrency, WeightToLiborAdjustmentMethod.Constant, true /*MulticurveFlag*/);
